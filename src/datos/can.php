...
class Can{
    ...
    function registrarCan($nombre, $raza, $edad, $sexo, $tamano, $genero, $observacionesMedicas, $descripcion, $foto1, $foto2, $foto3) 
    {
        $sql = "INSERT INTO Can (Nombre, Raza, Edad, Sexo, Tamano, Genero, ObservacionesMedicas, Descripcion, Foto1, Foto2, Foto3) 
                VALUES (:nombre, :raza, :edad, :sexo, :tamano, :genero, :observacionesMedicas, :descripcion, :foto1, :foto2, :foto3)";
