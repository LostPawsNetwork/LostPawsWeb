                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full bg-white border border-gray-200 rounded-lg text-center mt-8">
                        ...
                        <tbody>
                            ...
                            $testimonios = [
                                ['id_testimonio' => 1, 'fecha' => '2024-01-01', 'texto' => 'Texto del testimonio 1', 'id_usuario' => 101, 'foto' => 'path/to/foto1.jpg'],
                                ['id_testimonio' => 2, 'fecha' => '2024-02-01', 'texto' => 'Texto del testimonio 2', 'id_usuario' => 102, 'foto' => 'path/to/foto2.jpg'],
