                    ...
                    <table class="min-w-full bg-white border border-gray-200 rounded-lg text-center">
                        ...
                        <tbody>
                            ...
                            foreach ($examenes as $examen) {
                                ...
                                echo "<td class='py-2 px-4 border-b'><a href='{$examen['link_examen']}' class='text-blue-600 hover:underline'>Ver examen</a></td>";
                            ?>
                                <td class="py-2 px-4 border-b"><button id="aceptarExa" class="bg-green-500 mr-2 text-white p-2 rounded-md hover:bg-green-600">Aceptar</button><button id="rechazarExa" class="bg-red-500 text-white p-2 rounded-md hover:bg-red-600">Rechazar</button></td>
                                </tr>
                            <?php }
                            ?>
                        </tbody>
