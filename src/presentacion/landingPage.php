        ...
        <div class="flex-1">
            ...
            <main id="page-content" class="transition-transform duration-300 ease-in-out flex-1 p-4" style="top: 4rem; height: calc(100% - 4rem)">
                ...
                <section id="adopta" class="text-center py-10 bg-bluey-light">
                    ...
                    <a href="visualizarCanes.php" class="bg-bluey-medium hover:bg-bluey-dark text-white font-bold py-2 px-4 rounded">
                        Adopta
                    </a>
                </section>
                ...
                <section id="donar" class="py-10 bg-bluey-medium">
                    <div class="container mx-auto text-center">
                        ...
                        <a href="formDonar.php" class="bg-bluey-dark hover:bg-bluey-light text-white font-bold py-2 px-4 rounded">
                            Donar
                        </a>
                    </div>
                </section>
                ...
                <section id="testimonios" class="py-10 bg-bluey-light">
                    <div class="container mx-auto text-center grid place-content-center mt-16 mb-16">
                        ...
                        <p class="text-bluey-dark pb-10">Descubre las historias de mascotas y dueños felices gracias a nuestra ayuda.</p>
